...
public class HbaseBaseSelectWithShard extends GeoMesaBaseSelect {
    private static Logger baseSelect = Logger.getLogger("baseSelect");

    // uses gdelt data
    public HbaseBaseSelectWithShard(String[] args) throws ParseException {
    ...
    public static void main(String[] args) {
        try {
            new HbaseBaseSelectWithShard(args).run();

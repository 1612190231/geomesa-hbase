...
public abstract class GeoMesaBaseInsert implements Runnable {
    ...
    public GeoMesaBaseInsert(String[] args, Param[] parameters, TutorialData data) throws ParseException {
        this(args, parameters, data, false);
        baseInsert.info("GeoMesaQuickStart Init...");
    }

    public GeoMesaBaseInsert(String[] args, Param[] parameters, TutorialData data, boolean readOnly) throws ParseException {

...
public abstract class GeoMesaSelectWithShard implements Runnable {
    private static final Logger baseSelect = Logger.getLogger("baseSelect");
    private final Map<String, String> params;
    private final TutorialData data;
    private final boolean cleanup;
    private final boolean readOnly;

    public GeoMesaSelectWithShard(String[] args, Param[] parameters, TutorialData data) throws ParseException {
        this(args, parameters, data, false);
        baseSelect.info("GeoMesaQuickStart Init...");
    }

    public GeoMesaSelectWithShard(String[] args, Param[] parameters, TutorialData data, boolean readOnly) throws ParseException {

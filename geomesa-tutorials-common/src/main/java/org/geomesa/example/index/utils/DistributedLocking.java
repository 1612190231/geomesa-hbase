//package org.geomesa.example.index.utils;
//
...
//     * @return the lock
//     */
//    protected def acquireDistributedLock(String key): Releasable
//
//    /**
//     * Gets and acquires a distributed lock based on the key.
//     * Make sure that you 'release' the lock in a finally block.
...
//     */
//    protected def acquireDistributedLock(String key, Long timeOut): Option[Releasable]
//
//    /**
